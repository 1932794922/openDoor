...
void LCD_Draw_fillRectangle1(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2,uint16_t RGB_Code);      //画实心矩形1
void LCD_Draw_fillRectangle2(uint16_t x,uint16_t y,uint8_t wide ,uint16_t RGB_Code);									//画实心矩形1
...
void WriteOneHzChar(uint16_t x,uint16_t y,uint8_t *font ,  uint16_t RGB_Code,uint16_t back_color);//显示16*16字体
void WriteHz32Char(uint16_t x,uint16_t y,uint8_t *font, uint16_t RGB_Code, uint16_t back_color);//显示32*32字体
void LCD_ShowString(uint16_t x0, uint16_t y0,uint8_t *pcStr,  uint16_t RGB_Code,uint16_t back_color);
void Draw_button(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2,char* ch,uint16_t len,uint16_t RGB_Code,uint16_t back_color);//做一个按键
